...
public class FeatureGenImpl implements FeatureGeneratorNested {
    ...
    /**
     * loadPriorPolarityFeature for incorporating new FeatureTypes based on priPolarity
     * and polarReversal dictionaries.
     */
    protected LoadPriorPolarityFeature loadPriorPolarityFeature;
    ...
    protected void addFeatures() { 
        ...
        /**
         * My new FeatureType: PriorPolarityFeatures
         */
        addFeature(new PriorPolarityFeatures(this, dict,
                loadPriorPolarityFeature.getPriorPolarityMap()));
        /**
         * PrePolarReverseFeatures FeatureType, consider polarity reversing word before current token
         */
...
//            strToInt.put(feature.identifier().clone(), new Integer(newId));
    ...
    public FeatureGenImpl(Model m, int numLabels, boolean addFeatureNow) throws Exception {
        // Read two polarity dictionaries
        this.loadPriorPolarityFeature = new LoadPriorPolarityFeature();
    ...
    public static boolean featureValidStatic(DataSequence data, int cposStart, int cposEnd, FeatureImpl featureToReturn,
                                             Model model, boolean cacheEdgeFeatures) {
