...
public class KnownInOtherState extends FeatureTypes {
    /**
     * These features fire for those states (labels) where the token does not appear, but it appears in
     * other states with greater than RARE_THRESHOLD frequency.
     */
    ...
    /**
     * return next eligible state id (which means this state must never appear with the token)
     */
    void nextStateId() {
