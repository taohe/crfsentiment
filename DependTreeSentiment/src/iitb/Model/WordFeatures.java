...
public class WordFeatures extends FeatureTypes {
    /**
	 * These features simply check whether the current token is present in the dictionary in the
     * particular state under consideration or not. The dictionary is created on-the-fly from the training set.
	 */
