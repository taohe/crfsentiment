 ...
 * Date: 5/17/13
 */
public class PolarReverseFeaturesTest {
    ...
    private PolarReverseFeatures polarReverseFeatures;   // testing object
    ...
    public void setUp() throws Exception {
        ...
        polarReverseFeatures = new PolarReverseFeatures(featureGen, dict,
    ...
    public void tearDown() throws Exception {
        ...
        featureGen = null;
        dict = null;
        polarReverseFeatures = null;
    }

    @Test
    public void simplePolarReverseFeatureTypeTest() {
        assertTrue(polarReverseFeatures.startScanFeaturesAt(sentTrainSeq, 5));  // "disease"
        assertTrue(polarReverseFeatures.hasNext());
    }
}
